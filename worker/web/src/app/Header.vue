...
import logo from "../../../../assets/images/mimir-wordmark.png";
...
<template>
  <header class="sticky top-0 z-20 border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
    <div class="mx-auto flex h-15 w-full max-w-[1500px] items-center">
      <RouterLink to="/sessions" aria-label="Mimir sessions" class="flex h-9 shrink-0 items-center focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600 sm:h-10"><img :src="logo" alt="mimir" class="h-9 w-auto max-w-none [image-rendering:pixelated] sm:h-11" /></RouterLink>
