export type Outcome = "promoted" | "discarded" | "abandoned" | "unknown";
...
export const sessions: Session[] = [
  { id: "01JZ7FZK9P", started_at: "2026-07-15T17:51:00Z", ended_at: null, repo: "mimir", source_ref: "master", harness: "OpenCode", model_primary: "GPT-5.6 Luna", state: "active", outcome: "unknown", request_count: 18, tokens_in: 230441, tokens_out: 4182, intent: "Replace custom dashboard authentication with Cloudflare Access", files: ["worker/src/app.ts", "worker/wrangler.jsonc", "internal/mimircli/dashboard.go"], errors: ["Access JWT audience was not configured"] },
  { id: "01JZ7FJ1WH", started_at: "2026-07-15T17:20:00Z", ended_at: "2026-07-15T17:58:00Z", repo: "mimir", source_ref: "master", harness: "Hermes", model_primary: "Claude Haiku 4.5", state: "inactive", outcome: "promoted", request_count: 7, tokens_in: 42361, tokens_out: 981, intent: "Add provider-aware request metadata for the dashboard", files: ["worker/migrations/0006_dashboard.sql", "worker/src/app.ts", "worker/test/integration.test.ts"], errors: [] },
  { id: "01JZ6Y2GRP", started_at: "2026-07-14T22:40:00Z", ended_at: "2026-07-14T23:14:00Z", repo: "portfolio", source_ref: "main", harness: "Claude Code", model_primary: "Gemini 2.5 Flash", state: "inactive", outcome: "promoted", request_count: 11, tokens_in: 121762, tokens_out: 2843, intent: "Repair broken image loading in the portfolio build", files: ["src/pages/Work.vue", "vite.config.ts"], errors: ["Asset URL resolved outside Vite base path"] },
  { id: "01JZ5PT6FK", started_at: "2026-07-14T15:52:00Z", ended_at: "2026-07-14T16:31:00Z", repo: "mimir", source_ref: "master", harness: "OpenCode", model_primary: "GPT-4o mini", state: "inactive", outcome: "promoted", request_count: 9, tokens_in: 88204, tokens_out: 1210, intent: "Consolidate command handling into the internal CLI package", files: ["cmd/mimir/main.go", "internal/mimircli/command.go", "internal/mimircli/setup.go"], errors: [] },
  { id: "01JZ4M9D7Q", started_at: "2026-07-13T20:18:00Z", ended_at: "2026-07-13T20:46:00Z", repo: "mimir", source_ref: "dashboard-experiment", harness: "OpenCode", model_primary: "GPT-5.6 Luna", state: "inactive", outcome: "discarded", request_count: 13, tokens_in: 164883, tokens_out: 3062, intent: "Prototype a Git-backed session synchronization flow", files: ["internal/mimircli/sync.go", "docs/Spec.md"], errors: ["Session sync conflicts with canonical remote D1 ownership"] },
  { id: "01JZ3A2KPM", started_at: "2026-07-12T18:06:00Z", ended_at: "2026-07-12T18:17:00Z", repo: "mimir", source_ref: "master", harness: "Claude Code", model_primary: "Claude Sonnet 4", state: "inactive", outcome: "abandoned", request_count: 4, tokens_in: 31920, tokens_out: 402, intent: "Explore semantic embeddings for session search", files: ["worker/src/search.ts"], errors: ["Vectorize would add infrastructure outside the current scope"] }
];

export const overview = {
  totals: { requests: 1284, sessions: 42, input_tokens: 4800000, output_tokens: 126000 },
