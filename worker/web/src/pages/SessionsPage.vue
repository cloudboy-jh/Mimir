...
<template>
  <section>
    ...
    <div class="mb-4 flex flex-col gap-2 sm:flex-row">
      ...
      <label><span class="sr-only">Filter by outcome</span><select v-model="outcome" class="h-8.5 rounded-[5px] border border-zinc-300 bg-white px-2.5 text-[13px] text-zinc-800 focus:border-teal-700 focus:outline-none focus:ring-1 focus:ring-teal-700 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200"><option value="">All outcomes</option><option value="landed">Landed</option><option value="discarded">Discarded</option><option value="abandoned">Abandoned</option><option value="unresolved">Unresolved</option></select></label>
    </div>
