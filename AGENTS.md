...
- Shared PNG assets: `assets/images/`. Worker materialization must preserve assets imported by the dashboard. Regenerate the README architecture map with `go run ./scripts/generate-system-map.go`.
